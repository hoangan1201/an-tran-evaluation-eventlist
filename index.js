...
class View {
  ...
  saveEvent(eventId, updatedEvent) {
    const eventRow = document.getElementById(`event-${eventId}`);
    eventRow.querySelector(".event-cell").textContent = updatedEvent.eventName;
    eventRow.querySelector(".start-date-cell").textContent =
      updatedEvent.startDate;
    eventRow.querySelector(".end-date-cell").textContent = updatedEvent.endDate;
...
class Controller {
  ...
  async handleSaveEditEvent(eventId) {
    const eventRow = document.getElementById(`event-${eventId}`);
    const updatedEvent = {
      id: eventId,
      eventName: eventRow.querySelector(".event-cell input").value.trim(),
      startDate: eventRow.querySelector(".start-date-cell input").value,
      endDate: eventRow.querySelector(".end-date-cell input").value,
    };
    await eventAPI.editEvent(eventId, updatedEvent);
    ...
    this.view.saveEvent(eventId, updatedEvent);
    this.attachEventListener();
  }
